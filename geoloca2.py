...
class BirthInfoApp:
    def __init__(self, root):
        self.root = root
        self.root.title("မွေးဖွားမှတ်တမ်းစနစ်")  # "Birth Information System" in Myanmar
        ...
        try:
            ...
            self.my_bold_font = font.Font(family="Arial", size=10, weight="bold")
            messagebox.showwarning("သတိပြုရန်", "Myanmar Text font မတွေ့ပါ။ Arial font ကိုအစားသုံးထားပါသည်။")
    ...
    def create_widgets(self):
        ...
        state_entry.grid(row=0, column=1, sticky=tk.EW, padx=(0,5))
        ...
        city_entry.grid(row=1, column=1, sticky=tk.EW, padx=(0,5))
        
        # Search button
        search_btn = ttk.Button(state_city_frame, text="ရှာဖွေရန်", command=self.search_location)  # "Search"
        search_btn.grid(row=1, column=2, padx=(5,0))
